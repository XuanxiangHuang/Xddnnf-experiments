...
# -*- coding:utf-8 -*-
#
#   experiment: Explaining SDD Classifiers (one-hot-encoding)
...
from src.decision_tree_ohe import *
from src.ddnnf_ohe import SDD
from src.explain.xpsdd_ohe import XpSdd
################################################################################
...
def explain_sdd(dataset, dt_file, save_dir):
    ...
    for i in range(d_len):
        xpsdd = XpSdd(Sdd.root, Sdd.b_nv, Sdd.o_nv, Sdd.b_feats, Sdd.o_feats,
